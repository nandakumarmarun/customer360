...
(function () {
  ...
  function openHoldingsExplorerModal(categoryCfg) {
    ...
    function loadActiveCategoryItems() {
      ...
      if (activeTab) {
        activePreviewTabId = activeTab.rightTabs && activeTab.rightTabs.length > 0 ? activeTab.rightTabs[0].id : "details";
      }
      ...
      if (categoryCfg.endpoint && activeTab.useSharedData && categoryData) {
