...
(function () {
  ...
  function renderCasesHeader() {
    const $header = $(".qm-header-inline");
    if (!$header.length || !$header.hasClass("cases-active")) {
      $header.removeClass("leads-active holdings-active activities-active mandates-active cards-active").addClass("cases-active");
      $header.empty();
          ...
          if (window.UIRenderer) {
            ...
            $content.html(`
              <div style="text-align:center; padding: 40px;">
                ...
                <div style="color:#ef4444; font-weight:600; font-size:14px;">Failed to load cases: ${escapeHtml(errorMessage)}</div>
              </div>
            `);
          }
        }
        ...
        <tr>
          <td colspan="6" style="text-align: center; padding: 40px;">
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px;">
              ...
              <div style="font-size: 15px; font-weight: 700; color: var(--text); margin-top: 8px; font-family: 'Outfit', sans-serif;">No Cases Found</div>
